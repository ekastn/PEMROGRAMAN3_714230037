...
// @Description Membuat akun baru dan mengembalikan ID akun yang baru dibuat.
// @Tags Auth
// @Accept json
// @Produce json
// @Param credentials body model.UserLogin true "Register credentials"
// @Success 200 {object} model.RegisterResponse "Register success"
